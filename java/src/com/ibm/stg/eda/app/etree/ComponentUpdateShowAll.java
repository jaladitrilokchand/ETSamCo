...
public class ComponentUpdateShowAll extends TkAppBase {

    /**
     * Constants.
     */
    public static final String APP_NAME = "compup.showAll";
     ...
     * 
     */
    public ComponentUpdateShowAll(EdaContext aContext, ToolKit aTk,
     ...
     */
    public ComponentUpdateShowAll(EdaContext aContext) throws IcofException {
	...
	try {
	    ...
	    myApp = new ComponentUpdateShowAll(null);
	    start(myApp, argv);
	}
	...
	for (String location : locations) {
	    readFromDb(xContext, location);
	    show(xContext, location);
	}
     ...
     * @throws IcofException 
     */
    private void show(EdaContext xContext, String locName) 
    throws IcofException {
     ...
     * @throws IcofException 
     */
    private void readFromDb(EdaContext xContext, String locName) 
    throws IcofException {

	setCompVersion(xContext, locName);
	
	// Look up the location
	setLocation(xContext, locName);
     ...
     * @throws IcofException 
     */
    private void setCompVersion(EdaContext xContext, String locName) 
    throws IcofException {
	...
	// Set the TK if loc is prod
	if (locName.equalsIgnoreCase("prod")) {
	    toolKit = null;
	    toolKit = new ToolKit(xContext, "14.1.build");
	    toolKit.dbLookupByName(xContext);
	    toolKit.getToolKit().getStageName().dbLookupById(xContext);
	}
	
	// Look up the component version
	...
	usage.append("------------------------------------------------------\n");
	usage.append("Displays Component Updates and Revisions for prod, shipb\n");
	usage.append("and tkb for the given Tool Kit and Component.\n");
	usage.append("\n");
	usage.append("USAGE:\n");
	usage.append("------\n");
