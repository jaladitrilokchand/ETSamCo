...
*=============================================================================
*
* FILE: ChangeRequestType_Db.java
*
*-PURPOSE---------------------------------------------------------------------
* ChangeRequest Type DB class
*-----------------------------------------------------------------------------
*
*
*-CHANGE LOG------------------------------------------------------------------
...
public class ChangeRequestType_Db extends TkAudit {

 	/**
	 * 
	 */
	private static final long serialVersionUID = 9185611244190194208L;
	/**
     * Constants.
     */
    public static final String TABLE_NAME = "TK.CHANGEREQUEST_TYPE";
    public static final String ID_COL = "CHANGEREQUEST_TYPE_ID";
    public static final String NAME_COL = "CHANGEREQUEST_TYPE";
     ...
     */
    public ChangeRequestType_Db(short anId) {
        setId(anId);
    }
     ...
     */
    public ChangeRequestType_Db(String aName) {
        setName(aName);
    }
