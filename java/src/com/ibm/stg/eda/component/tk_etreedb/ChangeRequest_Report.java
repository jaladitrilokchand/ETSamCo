...
public class ChangeRequest_Report extends TkAudit {
     ...
     * @param allFlag      If true show all ChangeRequests
     *                     otherwise show only non-DEV CRs
     * @throws IcofException 
     */
    public ChangeRequest_Report(EdaContext xContext, User_Db aUser, 
    ...
    private void setAll(boolean aFlag) { showAll = aFlag; }
	...
	//			  and crq.clearquest_id != 'DEV'         <-- Add always unless show all flag is true
     ...
     * @return
     */
    private String getAllFilter(EdaContext xContext) {
	
	String line = "";
	
	if (getShowAll() == false)
	    line = " and crq." + ChangeRequest_Db.CQ_COL + " NOT LIKE 'DEV%'";
