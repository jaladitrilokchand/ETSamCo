...
public class CompTkRelRole_Db extends TkAudit {

    /**
	 * 
	 */
	private static final long serialVersionUID = 2926203497456379134L;
	/**
     * Constants.
     */
    public static final String TABLE_NAME = "TK.COMPTKREL_ROLES";
    public static final String ID_COL = "COMPTKREL_ROLES_ID";
     ...
     */
    public CompTkRelRole_Db(long anId) {
        setId(anId);
    }
     ...
     */
    public CompTkRelRole_Db(String aName, String aDesc) {
        setName(aName);
