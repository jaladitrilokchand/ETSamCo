...
*=============================================================================
*
* FILE: BranchName.java
*
*-PURPOSE---------------------------------------------------------------------
* Branch Name DB class
*-----------------------------------------------------------------------------
*
*
*-CHANGE LOG------------------------------------------------------------------
...
public class BranchName_Db extends TkAudit {

    /**
	 * 
	 */
	private static final long serialVersionUID = 721654013778458822L;
	/**
     * Constants.
     */
    public static final String TABLE_NAME = "TK.BRANCHNAME";
    public static final String ID_COL = "BRANCHNAME_ID";
    public static final String NAME_COL = "BRANCH_NAME";
     ...
     */
    public BranchName_Db(String aName) {
        setName(aName);
    }
    ...
    public String toString(EdaContext xContext) {
        ...
        buffer.append("Branch name: " + getName() + "\n");
