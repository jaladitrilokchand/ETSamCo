...
*=============================================================================
*
* FILE: ChangeRequestSeverity_Db.java
*
*-PURPOSE---------------------------------------------------------------------
* ChangeRequest Severity DB class
*-----------------------------------------------------------------------------
*
*
*-CHANGE LOG------------------------------------------------------------------
...
public class ChangeRequestSeverity_Db extends TkAudit {

 	/**
	 * 
	 */
	private static final long serialVersionUID = 4473974511649885996L;
	/**
     * Constants.
     */
    public static final String TABLE_NAME = "TK.CHANGEREQUEST_SEVERITY";
    public static final String ID_COL = "CHANGEREQUEST_SEVERITY_ID";
    public static final String NAME_COL = "CHANGEREQUEST_SEVERITY";
     ...
     */
    public ChangeRequestSeverity_Db(short anId) {
        setId(anId);
    }
     ...
     */
    public ChangeRequestSeverity_Db(String aName) {
        setName(aName);
    }
