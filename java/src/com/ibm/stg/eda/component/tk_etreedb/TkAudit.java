...
public class TkAudit implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5468606193268060267L;
	/**
     * Constants.
     */
   ...
   public TkAudit(String aCreatedBy,
	...
	protected void setStatement(PreparedStatement aStatement) { statement = aStatement; }
    ...
    public void setNextIdQuery(EdaContext xContext, String table, String idColumn) {
        ...
        // Create the query.
        setQuery("select max(" + idColumn + ") from " + table);
    ...
    throws IcofException {
    	...
    	try {
    		...
    		IcofException ie = new IcofException(this.getClass() .getName(),
    				"closeStatement()", IcofException.SEVERE,
